  ...
  return (
    <div className='flex justify-center mt-10'>
      <div className='w-5/6 block  md:flex lg:flex justify-between gap-20'>
        <div className='w-full md:w-2/6 lg:w-2/6 flex flex-col items-center px-4'>
        ...
        <div className='w-full md:w-2/6 lg:w-2/6 flex flex-col items-center'>
          <h1 className='text-2xl font-medium mb-3'>Customer Support</h1>
          <ul className='flex flex-col items-center text-gray-600 gap-3 mt-4 font-extralight'>
